...
class LoginForm(forms.ModelForm):
    ...
    username = forms.CharField(widget=forms.TextInput(attrs={'class': 'form-control form-control-user', 'placeholder': 'Enter a Username'}))
...
class RegisterForm(forms.ModelForm):
    ...
    email = forms.EmailField(widget=forms.TextInput(attrs={'class': 'form-control form-control-user', 'placeholder': 'Email'}))
